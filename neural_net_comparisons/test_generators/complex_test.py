                ...
                for col in range(width):
                    ...
                    if digit == 0:  # Circle
                        center_dist = math.sqrt(
                            (normalized_row - 0.5) ** 2 +
                            (normalized_col - 0.5) ** 2
                        )
                        ...
                        pixel = (
                            1.0 if 0.3 <= normalized_col - pixel * 0.3 <= 0.4
                            else 0.0
                        )

                    elif digit == 3:  # Spiral
                        angle = math.atan2(normalized_row - 0.5,
                                           normalized_col - 0.5)
                        radius = math.sqrt(
                            (normalized_row - 0.5) ** 2 +
                            (normalized_col - 0.5) ** 2
                        ...
                        pixel = (
                            1.0 if abs(radius - angle / (2 * math.pi)) < 0.1
                            else 0.0
                        )

                    else:  # Complex patterns for other digits
                        freq = 1 + digit * 0.5
                        pixel = math.sin(normalized_row * freq * math.pi) * \
                            math.cos(normalized_col * freq * math.pi)
