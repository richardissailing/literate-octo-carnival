...
class Profiler:
    ...
    def __enter__(self):
        ...
        try:
            ...
            try:
                self.start_memory = getattr(self.process, 'get_memory_info')().rss
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        try:
            ...
            self.stats = ProfileStats(
                ...
                memory_peak=memory_snapshot.statistics('filename')[-1].size / 1024 / 1024,  # MB
    ...
    def save_stats(self, output_dir: Path, name: str):
        ...
        try:
            ...
            with open(readable_stats, 'w') as f:
                ...
                f.write(f"Peak Memory Usage: {self.stats.memory_peak:.2f} MB\n")
                f.write(f"Memory Difference: {self.stats.memory_diff:.2f} MB\n")
